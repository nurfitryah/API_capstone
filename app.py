...
def documentation():
    return '''
        <h1> Documentation </h1>
        <p> Repositori ini bertujuan untuk melengkapi Data Analytics Courde, dengan pemilihan case Deploying Application Programming Interface (API).
        ...
        <h2> Static Endpoints 1 (.../chinook) :</h2>
                ...
                <p> (contoh insightnya)
        <li>
        <h2> Static Endpoints 2 (.../mediatype) :</h2>
        ...
        <li>
        <h2> Dynamic Endpoints (Artist Name) (.../data/get/<artistname>) :</h2>
                <p> Data dynamic akan menunjukkan data dari nama artis yang dipilih saja. 
